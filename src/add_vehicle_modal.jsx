...
export function Add_Vehicle({onClose}){
        ...
        <div className="modal modal-open bg-black/40 fixed inset-0 z-50" onClick={onClose}>
            <div className="modal-box modal-middle z-20 max-h-[85vh]" onClick={e=>e.stopPropagation()}>
                ...
                <form className="flex flex-col w-full overflow-y-auto">
                    ...
                    <input type="text" name="model" id="model" className="input input-primary w-full mb-2.5"/>
                    ...
                    <input type="text" name="plate" id="plate" className="input input-primary w-full mb-2.5"/>

                    <label htmlFor="rate" className="text-md font-semibold">Daily Rate</label>
                    <input type="number" name="rate" id="rate" className="input input-primary w-full mb-2.5"/>

                    <label htmlFor="owner" className="text-md font-semibold">Owner</label>
                    <input type="text" name="owner" id="owner" className="input input-primary w-full mb-2.5"/>

                    <label htmlFor="desc" className="text-md font-semibold">Description</label>
                    <textarea name="desc" id="desc" className="textarea textarea-primary w-full mb-2.5"></textarea>

                    <label htmlFor="availability" className="text-md font-semibold">Availability</label>
                    <select name="availability" id="availability" className="select select-primary w-full mb-5">
